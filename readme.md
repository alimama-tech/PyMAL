...
<p align="center">
  ...
  <a href="#"> <img src='https://img.shields.io/badge/%F0%9F%A4%97%20Hugging%20Face-Dataset-blue' alt="Hugging Face"> </a>
</p>
...
To reproduce the results of the paper, the [TAOBAO-MAC](#) dataset is required. TAOBAO-MAC now is publicly available on [🤗 Hugging Face](#). You can download the dataset directly via `git clone`:
```bash
